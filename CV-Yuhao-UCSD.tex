...
Deep learning (DL) has achieved massive success lately. The demand for DL is rising, especially among the enterprises who own large business-critical datasets that reside in RDBMSs or other data systems. The DB community has long worked on bringing machine learning (ML) to DBMS-resident data. Given the accumulated experience of in-DBMS ML and recent advances in distributed DL training and model selection, it is now prime time to revisit the problem and ask \textit{how to bring DL support to DB-resident data?} Turns out there is no single ``best'' approach, and an interesting tradeoff space of alternative approaches exists. This project proposes four different approaches, contrasts them analytically using various criteria, e.g., runtime efficiency, ease of governance, and compares them empirically with large-scale DL workloads. Overall, there is a Pareto front worth exploring; for instance, some approaches may be 3x-6x faster but lack in governance and portability.\\
